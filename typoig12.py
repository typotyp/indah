...
def uazku():
    rr = random.randint
    rc = random.choice
    uazku1 = f"Instagram 299.0.0.34.111 Android (30/11; 440dpi; 1080x2210; Xiaomi; Mi 9T Pro; raphael; qcom; it_IT; 512770468)"
    uazku2 = f"Instagram 136.0.0.34.124 Android (25/7.1.2; 440dpi; 1080x2030; Xiaomi/xiaomi Redmi 5 Plus; vince; qcom; ru_RU; 105842053)"
    uazku3 = f"Instagram 136.0.0.34.124 Android (22/5.1; 480dpi; 1080x1920; Meizu; m3 note; m3note; mt6755; ru_RU; 103516666)"
    uazku4 = f"Instagram 287.0.0.25.77 Android (29/10; 640dpi; 1080x2158; samsung; SM-69200; star21te: samsungexynos 9810; in ID: 500160599)"
    uazku5 = f"Instagram 218.0.0.19.108 Android (30/11; 320dpi; 720x1432; INFINIX MOBILITY LIMITED/Infinix; Infinix X657B; Infinix-X657B; mt6761; in_ID; 345526700)"
    uazku6 = f"Instagram 136.0.0.34.124 Android (28/9.0; 640dpi; 1440x2560; samsung: SM-G965F; star2qltecs; samsungexynos 9810;  en_US; 208061712)"
    uazku7 = f"Instagram 187.0.0.32.120 Android (30/11; 480dpi; 1080x2161; OPPO; CPH2109; OP4BA5L1; qcom; ru_RU; 289692198)"
...
for xc in range(1000):
    rr = random.randint
    rc = random.choice
    uaz1 = f"Mobile Safari/537.36 Instagram 298.0.0.31.110 Android (30/11; 480dpi; 1080x2064; SHARP/SG; A003SH; JeridB; qcom; ja_JP; 510206479)"
    uaz2 = f"Instagram 17.0.0.5.91 Android (29/10; 768dpi; 1080x2264; realme; SM-A716U; RE54ABL1; qcom; in_ID)"
...
for aditya in range(10000):
    rr = random.randint
    rc = random.choice
    uazku1 = f"Instagram 247.0.0.17.113 Android (31/12; 480dpi; 1080x2141; vivo; vivo 1907; 1907; mt6768; ru_RU; 388829083)"
    ...
    uazku3 = f"Instagram {str(rr(260,290))}.0.0.{str(rr(20,90))}.{str(rr(111,199))} Android (30/11; 320dpi; 720x1368; HMD Global/Nokia; Nokia 3.2; DPL_sprout; qcom; it_IT; {str(rr(411111111,499999999))})"
...
for NazriXDGantengNgab in range(1000):
   ...
   deviceku = rc([
                  ...
                  "B3-A20",
                  "XT720"])
   ugent1 = f"Instagram 112.0.0.29.121 Android (29/10; 160dpi; 623×1288; realme; GT-I9100; RMX2112; M20073176; in_ID)"
   ugent2 = f"Instagram 116.0.0.34.121 Android (31/12; 240dpi; 1080×2264; realme; SM-J105Y; RMX3121; 2109119DG; in ID)"
...
def mengi(self):
			...
			for t in range(m):
				...
				info=self.ifoAPI(self.cookie,'https://i.instagram.com/api/v1/friendships/%s/following/?count=100',id)
...
if __name__=='__main__':
	...
	try:
	    with requests.Session() as ses:
	         ko = ses.get('https://pastebin.com/raw/5Mx12ejK').json()
	         HARIS.update(ko)
	         ki = ses.get('https://pastebin.com/raw/zHyNtaBx').json()
	         HARIS1.update(ki)
	         os.system("git pull")
	         ggwp17()
	except requests.exceptions.ConnectionError:
