...
class Instagram:
    ...
    for xc in range(10000):
        ...
        UserAgents1 = f"Instagram 131.0.0.23.116 Android (30/11; 133dpi; 1080-2290; realme; SM-3111F; RMX2155; M20103195Y;  in_ID)"
        UserAgents2 = f"Instagram 245.0.0.13.110 (iPhone13,2; iOS 15_6; en_US; en-US; scale=3.66; 1170x2533; 384816942)"
        UserAgents3 = f"Instagram 215.0.0.27.359 Android (30/11; 320dpi; 720x1448; realme; RMX3201; RMX3201; mt6765; ru_RU; 337202351)"
        UserAgents4 = f"Instagram 136.0.0.34.124 Android (28/9.0; 640dpi; 1440x2560; samsung: SM-G965F; star2qltecs; samsungexynos 9810;  en_US; 208061712)"
        UserAgents5 = f"Instagram 218.0.0.19.108 Android (30/11; 320dpi; 720x1432; INFINIX MOBILITY LIMITED/Infinix; Infinix X657B; Infinix-X657B; mt6761; in_ID; 345526700)"
        UserAgents6 = f"Instagram 187.0.0.32.120 Android (30/11; 480dpi; 1080x2161; OPPO; CPH2109; OP4BA5L1; qcom; ru_RU; 289692198)"
...
{N}[{H}+{N}] {H}OK(SELAMAT){N}
 ...
 {N}├╴>{N} following : {H}{ful}{N}
    ...
    def metode(self):
        urut = []
        urut.append(Panel(f"{U2}Methode {U2}OReqomen{P2}",title=f"{H2}01{P2}",width=25,padding=(0,4),style=f"{color_table}"))
        urut.append(Panel(f"{M2}Methode {M2} coid🙂 {P2}",title=f"{H2}02{P2}",width=25,padding=(0,4),style=f"{color_table}"))
        urut.append(Panel(f"{M2}Methode {M2}coid🤷",title=f"{H2}03{P2}",width=27,padding=(0,6),style=f"{color_table}"))
        console.print(Columns(urut))
